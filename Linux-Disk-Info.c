...
void afficher_buffer(const unsigned char* buffer, const unsigned long numeroSecteur){
  int i;
...
int afficherSecteur(const unsigned long numeroSecteur, const char* cheminDisque){
...
int existe(const unsigned char* buffer,const unsigned char* chaineinfo){
int i=0;
int j=0;
...
int* rechercher_secteur(const char* chaineinfo, const unsigned long secteur_debut, const unsigned long secteur_fin, const char* cheminDisque){
...
unsigned char * lire_secteur(const unsigned long numeroSecteur, const char * cheminDisque){
  FILE* disque;
